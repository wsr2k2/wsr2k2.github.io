...
const categorias = {
    Filme_de_Terror: ["premoniçao", "annabelle", "hellraiser", "halloween", "cadaver", "poltergeist", "psicose", "carrie",],
    Bandas_de_Rock: ["metallica", " queen", "nirvana", "korn", "acdc", "kiss", "ramones", "rush", "yes", "slipknot", "motorhead", "sepultura", "angra", ""],
    Pizzas: ["portuguesa", "mussarela", "atum", "calabresa", "marguerita", "peperoni", "catupiry", "aliche", "napolitana", "baiana", "brocolis", "escarola"],
    Países: ["brasil", "uruguai", "argentina", "italia", "canada", "espanha"]
};
...
function defineParalavraProposta(){
